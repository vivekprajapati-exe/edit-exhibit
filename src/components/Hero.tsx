  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute w-full h-full bg-grid-black/[0.2] [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]" />
      </div>
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                Bringing Stories to Life Through <span className="relative px-2 py-1 whitespace-nowrap">
                  <span className="relative z-10">Expert Editing</span>
                  <span className="absolute inset-0 bg-gray-100 rounded-md -z-10"></span>
                </span>
              </h1>
            </motion.div>
            ...
            <motion.div
              ...
              className="pt-4"
            >
              <Button className="rounded-full px-8 py-6 bg-black hover:bg-gray-800 text-white font-medium text-lg">
